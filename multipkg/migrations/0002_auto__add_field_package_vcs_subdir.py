...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.vcs_subdir'
        db.add_column(u'multipkg_package', 'vcs_subdir',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.vcs_subdir'
        db.delete_column(u'multipkg_package', 'vcs_subdir')
    ...
    models = {
        ...
        u'multipkg.package': {
            ...
            'vcs_subdir': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
