...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Package.vcs_subdir'
        db.alter_column(u'multipkg_package', 'vcs_subdir', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Package.vcs_subdir'
        db.alter_column(u'multipkg_package', 'vcs_subdir', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
    ...
    models = {
        ...
        u'multipkg.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['multipkg.Package']"})
        },
        u'multipkg.package': {
            ...
            'vcs_subdir': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512', 'blank': 'True'}),
